    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                ...
                <Button onClick={isApplied ? null : applyJobHandler} disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-[#7209b7] hover:bg-[#2a1c44] text-white'}`}>{isApplied ? "Already Applied " : "Apply Now"}</Button>
            </div>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Experience : <span className='pl-4 font-normal text-gray-900'>{singleJob?.experienceLevel} Years</span></h1>
